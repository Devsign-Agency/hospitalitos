...
class GridViewedPreviews extends StatelessWidget {
  final Future future;

  const GridViewedPreviews({super.key, required this.future});
...
class _CardImagePreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: 180,
      child: ViewedPreview(
          title: title ?? 'no title', backgroundImage: image, onTap: () => {}),
    );
  }
}
